...
require (
    github.com/Dzmuh/hugo-bootstrap5-themes/modules/bootstrap5-scss v1.0.0
    github.com/Dzmuh/hugo-bootstrap5-themes/modules/bootstrap5-base-theme v1.0.0
)

replace (
    github.com/Dzmuh/hugo-bootstrap5-themes/modules/bootstrap5-scss => ../../modules/bootstrap5-scss
